...
import ModalNewPorject from "./ModalNewProject";
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            <input
              ...
              className="rounded-md border py-1 pl-10 pr-4 focus:outline-none dark:border-dark-bg-dark-secondary dark:bg-dark-bg-dark-secondary dark:text-white"
            />
